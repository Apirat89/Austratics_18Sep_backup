...
function AdminResetPasswordContent() {
  ...
  useEffect(() => {
    ...
    // Add debug logging
    console.log('🔑 Admin Reset Password Page Loaded - Token:', resetToken ? 'Present' : 'Missing');
  }, []);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess('Admin password reset successfully! You can now sign in with your new password.');
      
      // Redirect to admin signin page after 3 seconds
      setTimeout(() => {
        ...
        <div style={{ position: 'relative', zIndex: 2 }} className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-white/20 max-w-md mx-4">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">
              This admin password reset link is invalid or has expired. Please request a new one.
            </p>
            <Link 
      ...
      >
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            {/* Add a clear admin indicator badge */}
            <div className="mt-3 inline-block bg-red-600 text-white px-4 py-1 rounded-full text-sm font-bold animate-pulse">
              ADMIN SYSTEM
            </div>
          </div>
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-white/20">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              >
                {isLoading ? 'Updating Password...' : 'Update Admin Password'}
              </button>
            </form>
          ...
          <div style={{ marginTop: '2rem', textAlign: 'center' }}>
            <div style={{
              ...
              <span>Your admin password will be securely encrypted</span>
            </div>
          </div>
